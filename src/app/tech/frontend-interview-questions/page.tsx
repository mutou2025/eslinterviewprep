        ...
        <div className="p-8">
            <div className="max-w-4xl mx-auto">
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 bg-[#DBEAFE] rounded-xl flex items-center justify-center group-hover:bg-blue-200 transition-colors">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-[#2563EB] mt-2">{topic.count}+ questions</p>
                                    </div>
                                </div>
                            </Link>
                        )
                ...
                <div className="bg-gradient-to-r from-[#0B1F3B] to-[#2563EB] rounded-2xl p-6 text-white">
                    ...
                    <Link
                        href="/review/qa"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#2563EB] rounded-xl font-medium hover:bg-[#EFF6FF] transition-colors"
                    >
                        Start Review
